import {
  ...
  import { colors, network } from "../externals/constants";
  import { Ionicons } from "@expo/vector-icons";
  import { AntDesign } from "@expo/vector-icons";
  import ProductList from "../externals/components/ProductList/ProductList";
  import CustomAlert from "../externals/components/CustomAlert/CustomAlert";
  import CustomInput from "../externals/components/CustomInput/";
  import ProgressDialog from "react-native-progress-dialog";
  
  const ViewProductScreen = ({ navigation, route }) => {
    // const { authUser } = route.params;
    const authUser  = "shoes";
